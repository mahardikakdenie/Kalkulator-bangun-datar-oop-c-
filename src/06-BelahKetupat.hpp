...
class BelahKetupat : public BangunRuang{
    public:
        void LuasBelahKetupat(){
            ...
            cout<<"Masukan Panjang Diagonal 1 : ";cin>>value1;
            cout<<"Masukan Panjang Diagonal 2 : ";cin>>value2;
        }
        void Display(){
            cout<<"\nRumus Luas BelahKetupat: 0.5 * Diagonal1 * diagonal2"<<endl;
            cout<<"Luas BelahKetupat = 0.5"<<" * "<<value1<<" * "<<value2<<endl;
        ...
        void DisplayK () {
            ...
            Hasil = value1 * 4 ;
            cout << "Rumus Keliling Belah Ketupat : " << value1 << " *  4"<<" = "<<Hasil<<endl;
